import { Container, Heading, Text, Stack, Card, Flex, Box, SimpleGrid } from '@chakra-ui/react';
...
const Skills = () => {
  ...
  <Box maxW={{ base: "container.sm", md: "container.md", lg: "container.xl" }} p={16}>
    ...
    >
        ...
        card.style.transform = `perspective(1000px) rotateY(${x * rotationValue}deg) rotateX(${y * -rotationValue}deg) translateZ(1px) scale(1.25)`;
      }}
      onMouseLeave={(e) => {
  ...
  onMouseLeave={(e) => {
    e.currentTarget.style.transform = "perspective(1000px) rotateY(0) rotateX(0) translateZ(0) scale(1)";
  }}
  style={{
    width: "125px",
    height: "125px",
